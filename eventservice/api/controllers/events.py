...
from api.controllers.config import URL_PREFIX
...
from api.cache import memoize, memoize_query, CACHE_GET_EVENTS, CACHE_GET_EVENT, CACHE_GET_EVENTIMAGES, CACHE_GET_CATEGORIES
