...
class DerInteger(DerObject):
    ...
    def __init__(self, value: Optional[int] = 0, implicit: Optional[int] = None,
                 explicit: Optional[int] = None) -> None: ...
...
class DerSequence(DerObject):
    def __init__(self, startSeq: Optional[Sequence[Union[int, DerInteger, DerObject]]] = None,
                 implicit: Optional[int] = None) -> None: ...
    ...
    def decode(self, der_encoded: bytes, strict: Optional[bool] = False, nr_elements: Optional[int] = None,
               only_ints_expected: Optional[bool] = False) -> DerSequence: ...
...
class DerObjectId(DerObject):
    ...
    def __init__(self, value: Optional[str] = ..., implicit: Optional[int] = None,
                 explicit: Optional[int] = None) -> None: ...
...
class DerBitString(DerObject):
    ...
    def __init__(self, value: Optional[bytes] = ..., implicit: Optional[int] = None,
                 explicit: Optional[int] = None) -> None: ...
